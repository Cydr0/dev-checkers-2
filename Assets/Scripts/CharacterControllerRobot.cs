...
public class CharacterControllerRobot : MonoBehaviour {
    ...
    public void createCharacter(int c) {
        this._class = c;
        this._index = PlayerVariables.getNextCharacterIndex(1);
        switch(c) {
            case 1:
        ...
        PlayerVariables.playerOneCharacters[this._index] = this;
        return;
    }
}
